...
public class Player : MonoBehaviour
{
    ...
    public GameObject snakeSituation;// Snake 상황을 관리 (Start Position Snake)
    ...
    private SnakeSituation snake;// fractureSituation 오브젝트의 Component인 FractureSituation 스크립트를 가져옴
